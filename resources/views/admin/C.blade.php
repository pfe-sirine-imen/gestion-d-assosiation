...
<div class="card">
    <div class="header">
       <div class="col-md-8">
        ...
        <form action="/admin/C"  method="POST" enctype="multipart/form-data">
          @csrf
              
              <div class="form-group">
                <label  style="color:#FF0000";>*  </label>
                <label>N CIN </label>
                <input type="number"  class="form-control" min="0" value="{{ old('cin') }}" name ="cin" placeholder="N CIN " >
                @if($errors->any('cin'))
            ...
            <div class="form-group">
                ...
                <input type="text"  class="form-control" value="{{ old('activite') }}" name ="activite" placeholder="Nom  du projet" >
            ...
            <div class="form-group">
                ...
                <input type="text"  class="form-control" value="{{ old('responsable') }}" name ="responsable" placeholder="  la Responsable d'assosiation" >
            ...
            <div class="form-group">
                ...
                <input type="text"  class="form-control" value="{{ old('benefice') }}" name ="benefice" placeholder=" Bénéficiaire" >
