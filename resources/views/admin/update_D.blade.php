...
<div class="card">
    <div class="header">
      ...
      <h4 Align=Center> Modifier les stocks des dons</h4>
        ...
        <form action="/admin/update_D/trat" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name ="bailleur_id" class="form-control" placeholder="A quel Bailleur" >
                ...
                <a href="/listeD" style="background-color:#A569BD ; border-color:#A569BD ; color:white" class="btn btn-info btn-fill pull-right" >Revenir a liste des stocks des dons</a>
