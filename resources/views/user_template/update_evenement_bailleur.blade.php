...
<div class="card">
    <div class="header">
       <div class="col-md-8">
      <h4 class="title">Formulaire pour Modifier  des evenements (Bailleur de fond)</h4>
            @if(session('status'))
        ...
        <form action="/update_eve_bailleur/trat" method="POST"  enctype="multipart/form-data">
              ...
              <input type="text" name="id" style="display:none;" value="{{ $even->id }}">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="avatar" name="facture" value="{{$even->facture}}"   accept="image/png, image/jpeg">
